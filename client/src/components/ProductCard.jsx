    ...
    <div className="border rounded-md p-4">
      ...
      <div className="mt-12 flex justify-center">
        {user ? (
          product.quantity === 0 ? (
            <button
              className="bg-red-500 hover:bg-red-400 text-white py-2 px-4 rounded w-1/3 disabled"
              disabled
            >
              Out of Stock
            </button>
            ...
            <button
              ...
              className="bg-green-600 hover:bg-green-400 text-white py-2 px-4 rounded w-1/3"
            >
